...
pub use messages::{
    ...
    parse_record_batch_records, AclCreation, AclCreationResult, AclDescription, AclOperation,
...
mod tests {
    ...
    fn test_api_key_from_i16() {
        ...
        assert_eq!(ApiKey::from_i16(15), Some(ApiKey::DescribeGroups));
        assert_eq!(ApiKey::from_i16(16), Some(ApiKey::ListGroups));
