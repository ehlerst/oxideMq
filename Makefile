...
run: ## Run oxideMq broker daemon locally with info logging (Kafka :9092, Admin :9093)
...
docker-run: ## Run Docker container daemon in detached mode
	docker run -d --name oxidemq -p 9092:9092 -p 9093:9093 ehlers320/oxidemq:latest
